...
} elseif (!str_ends_with(strtolower($correo),"@inemjose.edu.co")) {
    ...
    <main class="auth-container">
        <section class="auth-card">
            ...
            <form action="registro.php" method="POST">
                ...
                <input type="email" id="correo" name="correo" pattern=".+@inemjose\.edu\.co" title="Debes usar tu correo institucional @inemjose.edu.co." required>
